    ...
    c = t(function (t) {
      ...
      t.exports = function (t) {
        ...
        return void 0 === t
          ...
          : null === t
          ? "Null"
          : "string" == typeof (u = o((i = Object(t)), n))
          ? u
          : r
          ? e(i)
          : "Object" == (c = e(i)) && "function" == typeof i.callee
          ? "Arguments"
          : c;
      };
    }),
    ...
    V = t(function (t) {
      ...
      t.exports = function (t, u, s, a, f, l, p) {
        ...
        var h,
          ...
          P = A[n] || A[r] || (f && A[f]),
          E = P || v(f),
          j = f ? (x ? v("entries") : E) : void 0,
          F = ("Array" == u && A.entries) || P;
        if (
          (F &&
            (y = z(F.call(new t()))) !== Object.prototype &&
            y.next &&
            (G(y, _, !0), S || b(y, n) || m(y, n, c)),
          x &&
            P &&
            P.name !== i &&
            ((g = !0),
          ...
          if (
            ((h = { values: x ? E : v(i), keys: l ? E : v(o), entries: j }), p)
          )
            for (d in h) d in A || w(A, d, h[d]);
          else O(O.P + O.F * (e || g), u, h);
        return h;
      };
    }),
    W =
          ...
          "Array",
          {
            from: function (t) {
              var n,
                ...
                l = Q(i);
              if (
                (a && (s = E(s, c > 2 ? arguments[2] : void 0, 2)),
                null == l || (u == Array && $(l)))
              )
                for (e = new u((n = k(i.length))); n > f; f++)
                  lt(e, f, a ? s(i[f], f) : i[f]);
              else
                for (o = l.call(i), e = new u(); !(r = o.next()).done; f++)
        ...
        O(O.P + O.F * (n || !pt(t)), "Array", {
          lastIndexOf: function (e) {
            ...
            var r = F(this),
              ...
              i = o - 1;
            for (
              arguments.length > 1 && (i = Math.min(i, x(arguments[1]))),
                i < 0 && (i = o + i);
              i >= 0;
              i--
            )
          ...
          return (
            ct(c.prototype, {
              ...
              forEach: function (t) {
                ...
                for (
                  var n,
                    r = E(t, arguments.length > 1 ? arguments[1] : void 0, 3);
                  (n = n ? n.n : this._f);

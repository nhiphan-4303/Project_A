  ...
  var t = function (t) {
    ...
    u = t(function (t) {
      ...
      t.exports = function (t) {
        ...
        return void 0 === t
          ...
          : null === t
          ? "Null"
          : "string" == typeof (a = i((o = Object(t)), e))
          ? a
          : r
          ? n(o)
          : "Object" == (s = n(o)) && "function" == typeof o.callee
          ? "Arguments"
          : s;
      };
    }),
    ...
    b = t(function (t) {
      t.exports = function (t, e) {
        if (!c(t)) return t;
        var r, n;
        if (e && "function" == typeof (r = t.toString) && !c((n = r.call(t))))
          return n;
        if ("function" == typeof (r = t.valueOf) && !c((n = r.call(t))))
          return n;
        if (!e && "function" == typeof (r = t.toString) && !c((n = r.call(t))))
          return n;
    ...
    x = t(function (t) {
      ...
      (g.inspectSource = function (t) {
        ...
        (t.exports = function (t, r, n, a) {
          ...
          s && (m(n, "name") || y(n, "name", r)),
            t[r] !== n &&
              (s && (m(n, e) || y(n, e, t[r] ? "" + t[r] : o.join(String(r)))),
              t === i
                ? (t[r] = n)
                : a
                ? t[r]
    ...
    F = t(function (t) {
      t.exports = h
        ...
        : function (t, e) {
            f(t);
            for (var r, n = I(e), i = n.length, o = 0; i > o; )
              w.f(t, (r = n[o++]), e[r]);
            return t;
          };
    }),
    ...
    q = t(function (t) {
      ...
      t.exports =
        ...
        function (t, o) {
          ...
          return (
            null !== t
              ? ((r[n] = f(t)), (a = new r()), (r[n] = null), (a[e] = t))
              : (a = i()),
            void 0 === o ? a : F(a, o)
          );
        };
    ...
    z = t(function (t) {
      ...
      t.exports = function (t, n, i) {
        t &&
          !m((t = i ? t : t.prototype), r) &&
          e(t, r, { configurable: !0, value: n });
      };
    }),
    G = t(function (t) {
      "use strict";
      ...
      y(e, s("iterator"), function () {
        ...
        (t.exports = function (t, r, n) {
          (t.prototype = q(e, { next: v(1, n) })), z(t, r + " Iterator");
        });
    }),
    V = t(function (t) {
      t.exports = function (t) {
    ...
    W = t(function (t) {
      ...
      t.exports = function (t, s, u, c, f, l, h) {
        ...
        if (
          (P &&
            (b = H(P.call(new t()))) !== Object.prototype &&
            b.next &&
            (z(b, v, !0), T || m(b, e) || y(b, e, a)),
          g &&
            S &&
            S.name !== o &&
            ((_ = !0),
          ...
          if (
            ((p = { values: g ? A : w(o), keys: l ? A : w(i), entries: E }), h)
          )
      ...
      (t(function () {
        ...
        W(
          ...
          function () {
            ...
            return n >= r.length
              ? { value: void 0, done: !0 }
              : ((e = t(r, n)), (this._i += e.length), { value: e, done: !1 });
          }
        );
      }),
      t(function (t) {
    ...
    Z = t(function (t) {
      ...
      (t.exports = W(
        ...
        function () {
          ...
          return !t || r >= t.length
            ? ((this._t = void 0), X(1))
            : X(0, "keys" == e ? r : "values" == e ? t[r] : [r, t[r]]);
        },
        "values"
      )),
        (j.Arguments = j.Array),
    ...
    it = t(function (t) {
      ...
      t.exports = function () {
        ...
        if (s)
          ...
          new r(c).observe(l, { characterData: !0 }),
            (u = function () {
              l.data = f = !f;
            });
        } else if (a && a.resolve) {
        ...
        o.call(i, function () {
          ...
          if (
            (a &&
              ((e = at(function () {
                d
                  ? h.emit("unhandledRejection", o, t)
                  : (r = i.onunhandledrejection)
      ...
      k = function (t) {
        o.call(i, function () {
          ...
          d
            ...
            : (e = i.onrejectionhandled) && e({ promise: t, reason: t._v });
        });
      },
      S = function (t) {
        var e = this;
      ...
      return (
        ...
        (this._initBody = function (t) {
          if (((this._bodyInit = t), t))
            ...
            else if (v.arrayBuffer && v.blob && m(t))
    ...
    (function (t) {
      ...
      function u(t, e, n) {
        ...
        return function (o, a) {
          ...
          for (n.method = o, n.arg = a; ; ) {
            ...
            "throw" === f.type &&
              ((i = E), (n.method = "throw"), (n.arg = f.arg));
          }
        };
      }
      function c(t, e) {
      ...
      if (k) _ && (module.exports = k);
        ...
        (i.prototype = B.constructor = o),
          ...
          (k.AsyncIterator = s),
          (k.async = function (t, r, n, i) {
            var o = new s(e(t, r, n, i));
            return k.isGeneratorFunction(r)
              ? o
          ...
          (h.prototype = {
            ...
            finish: function (t) {
              for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                ...
                if (r.finallyLoc === t)
                  return this.complete(r.completion, r.afterLoc), l(r), O;
              }
            },
            catch: function (t) {
              for (var e = this.tryEntries.length - 1; e >= 0; --e) {
  ...
  var lt = t(function (t, e) {
      !(function (r, n) {
        ...
        var i = "0.7.37",
              ...
              for (r = i = 0; r < h.length && !u && h[r]; )
                if ((u = h[r++].exec(t)))
                  for (o = 0; o < p.length; o++)
                    (f = u[++i]),
                      typeof (a = p[o]) === c && a.length > 0
                        ? 2 === a.length
                          ? typeof a[1] == s
                            ? (this[a[0]] = a[1].call(this, f))
                            : (this[a[0]] = a[1])
                          : 3 === a.length
                          ? typeof a[1] !== s || (a[1].exec && a[1].test)
                            ? (this[a[0]] = f ? f.replace(a[1], a[2]) : n)
                            : (this[a[0]] = f ? a[1].call(this, f, a[2]) : n)
                          : 4 === a.length &&
                            (this[a[0]] = f
                              ? a[3].call(this, f.replace(a[1], a[2]))
                              : n)
                        : (this[a] = f || n);
              l += 2;
            }
          ...
          rt = function (t, e) {
            if ((typeof t === c && ((e = t), (t = n)), !(this instanceof rt)))
              return new rt(t, e).getResult();
            ...
            return (
              ...
              (this.getDevice = function () {
                ...
                return (
                  ...
                  (t[d] = n),
                  J.call(t, a, x.device),
                  _ && !t[d] && y && y.mobile && (t[d] = m),
                  _ &&
                    "Macintosh" == t[h] &&
                    i &&
                    typeof i.standalone !== u &&
                    i.maxTouchPoints &&
                    i.maxTouchPoints > 2 &&
                    ((t[h] = "iPad"), (t[d] = g)),
                  t
        ...
        (rt.VERSION = i),
          (rt.BROWSER = K([p, w, l])),
          (rt.CPU = K([v])),
          (rt.DEVICE = K([h, b, d, y, m, x, g, _, k])),
          (rt.ENGINE = rt.OS = K([p, w])),
          "object" !== u
            ? ("object" !== u && t.exports && (e = t.exports = rt),
              (e.UAParser = rt))
    ...
    bt = t(function (t, r) {
      ...
      function a(t) {
        ...
        document.cookie =
          l + "=" + t + "; expires=" + n.toGMTString() + "; path=/";
      }
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        if (
                          !0 !==
                          new dt.Browser({ userAgent: navigator.userAgent })
                            .isSafari
                        ) {
                          t.next = 3;
                          break;
                ...
                function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 10:
                        return (
                          (s = t.sent), (u = s.eligible), t.abrupt("return", u)
                        );
                      case 15:
                        return (
                          (t.prev = 15),

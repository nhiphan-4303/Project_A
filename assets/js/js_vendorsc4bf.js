  ...
  (function (o, i, t, e) {
    var n = {
        ...
        (n.elem = t),
          ...
          n.options.enabled &&
            ...
            (e = o(
              n.options.gallery
                ? "#" + n.options.gallery
                : n.options.gallerySelector
            )).on("click.zoom", n.options.galleryItem, function (i) {
              if (
                (n.options.galleryActiveClass &&
                  (o(n.options.galleryItem, e).removeClass(
                    n.options.galleryActiveClass
                  ),
                  o(this).addClass(n.options.galleryActiveClass)),
                "A" === this.tagName && i.preventDefault(),
                o(this).data("zoom-image")
                  ? (n.zoomImagePre = o(this).data("zoom-image"))
                  : (n.zoomImagePre = o(this).data("image")),
                n.swaptheimage(o(this).data("image"), n.zoomImagePre),
                "A" === this.tagName)
              )
                return !1;
            }));
      ...
      startZoom: function () {
        ...
        (n.nzWidth = n.$elem.width()),
          ...
          "inner" === n.options.zoomType &&
            (n.zoomWindowStyle =
              ((i = n.$elem.css("border-left-width")),
          ...
          o(n.options.zoomContainerAppendTo).append(n.zoomContainer),
          ...
          "inner" !== n.options.zoomType &&
            ...
            n.options.tint &&
              ((n.tintContainer = o("<div/>").addClass("tintContainer")),
              (n.zoomTint = o(
                '<div class="zoomTint" style="' + n.tintStyle + '"></div>'
              )),
        ...
        function h(o) {
          (n.lastX === o.clientX && n.lastY === o.clientY) ||
            (n.setPosition(o), (n.currentLoc = o)),
            (n.lastX = o.clientX),
            (n.lastY = o.clientY);
        }
        (n.zoomWindow = o(
          ...
          (n.zoomWindowContainer = o("<div/>")
            .addClass("zoomWindowContainer")
            .css("width", n.options.zoomWindowWidth)),
          n.zoomWindow.wrap(n.zoomWindowContainer),
          "lens" === n.options.zoomType &&
            n.zoomLens.css("background-image", 'url("' + n.imageSrc + '")'),
          "window" === n.options.zoomType &&
            n.zoomWindow.css("background-image", 'url("' + n.imageSrc + '")'),
          "inner" === n.options.zoomType &&
            n.zoomWindow.css("background-image", 'url("' + n.imageSrc + '")'),
          n.options.touchEnabled &&
            (n.$elem.bind("touchmove", function (o) {
              o.preventDefault();
              var i =
            ...
            n.options.showLens &&
              (n.zoomLens.bind("touchmove", function (o) {
                o.preventDefault();
                var i =
          ...
          n.zoomContainer.bind("click", n.options.onImageClick),
          n.zoomContainer.bind("mousemove", function (o) {
            !1 === n.overWindow && n.setElements("show"), h(o);
          });
        var d = null;
        "inner" !== n.options.zoomType && (d = n.zoomLens),
          n.options.tint && "inner" !== n.options.zoomType && (d = n.zoomTint),
          "inner" === n.options.zoomType && (d = n.zoomWindow),
          d && d.bind("mousemove", h),
          n.zoomContainer
            .add(n.$elem)
          ...
          n.options.scrollZoom &&
            n.zoomContainer
              .add(n.$elem)
              .bind("wheel DOMMouseScroll MozMousePixelScroll", function (i) {
                (n.scrollLock = !0),
                ...
                return (
                  ...
                  t / 120 > 0
                    ? n.currentZoomLevel >= n.minZoomLevel &&
                      n.changeZoomLevel(
                        n.currentZoomLevel - n.options.scrollZoomIncrement
                      )
      ...
      setPosition: function (o) {
        ...
        this.options.responsive && !this.options.scrollZoom) &&
          ...
          "lens" !== this.options.zoomType &&
            ...
            this.zoomLens.css({ width: t, height: i }),
            this.options.tint &&
        ...
        if (
          ...
          (this.Etoppos = this.mouseTop < 0 + e),
            (this.Eboppos =
              this.mouseTop >
              this.nzHeight - e - 2 * this.options.lensBorderSize),
            (this.Eloppos = this.mouseLeft < 0 + n),
            (this.Eroppos =
              this.mouseLeft >
              this.nzWidth - n - 2 * this.options.lensBorderSize);
        }
        "inner" === this.options.zoomType &&
          ((this.Etoppos =
          ...
          this.mouseTop > this.nzHeight
            ...
            : (this.options.showLens &&
              ...
              "window" === this.options.zoomType && this.setWindowPosition(o),
              "inner" === this.options.zoomType && this.setWindowPosition(o),
              this.options.showLens &&
                (this.fullwidth &&
                  "lens" !== this.options.zoomType &&
                  (this.lensLeftPos = 0),
      ...
      showHideZoomContainer: function (o) {
        "show" === o && this.zoomContainer && this.zoomContainer.show(),
          "hide" === o && this.zoomContainer && this.zoomContainer.hide();
      },
      showHideWindow: function (o) {
        ...
        "show" === o &&
          ...
          i.options.zoomWindowFadeIn
            ? i.zoomWindow.stop(!0, !0, !1).fadeIn(i.options.zoomWindowFadeIn)
            : i.zoomWindow.show(),
          (i.isWindowActive = !0)),
          "hide" === o &&
            i.isWindowActive &&
      ...
      showHideLens: function (o) {
        "show" === o &&
          (this.isLensActive ||
            (this.options.lensFadeIn && this.zoomLens
      ...
      setTintPosition: function (o) {
        ...
        (this.nzOffset = this.$elem.offset()),
          (this.tintpos = String(-1 * (o.pageX - this.nzOffset.left - i / 2))),
          (this.tintposy = String(-1 * (o.pageY - this.nzOffset.top - t / 2))),
          this.Etoppos && (this.tintposy = 0),
          this.Eloppos && (this.tintpos = 0),
          this.Eboppos &&
            (this.tintposy =
              -1 * (this.nzHeight - t - 2 * this.options.lensBorderSize)),
          this.Eroppos &&
            (this.tintpos =
              -1 * (this.nzWidth - i - 2 * this.options.lensBorderSize)),
          this.options.tint &&
      ...
      swapAction: function (i, t) {
        ...
        if (
          ...
          e.setImageSource(h, i),
          (e.currentZoomLevel = e.options.zoomLevel),
          (e.options.maxZoomLevel = !1),
          "lens" === e.options.zoomType &&
            e.zoomLens.css("background-image", 'url("' + t + '")'),
          "window" === e.options.zoomType &&
            e.zoomWindow.css("background-image", 'url("' + t + '")'),
          ...
          if (
            (e.$elem.attr("src", i),
            e.$elem.after(a),
            a.stop(!0).fadeOut(e.options.imageCrossfade, function () {
              o(this).remove();
            }),
            ...
            e.zoomTintImage.attr("src", t),
              e.zoomTintImage.after(r),
              r.stop(!0).fadeOut(e.options.imageCrossfade, function () {
                o(this).remove();
              }),
              p.fadeIn(e.options.imageCrossfade),
              e.zoomTint.css({ height: s, width: n });
          }
          e.zoomContainer.css({ height: s, width: n }),
            "inner" === e.options.zoomType &&
              (e.options.constrainType ||
                (e.zoomWrap.parent().css({ height: s, width: n }),
                e.zoomWindow.css({ height: s, width: n }))),
            e.options.imageCrossfade && e.zoomWrap.css({ height: s, width: n });
        } else
          e.$elem.attr("src", i),
            e.options.tint &&
              (e.zoomTintImage.attr("src", t),
              e.zoomTintImage.attr("height", s),
              e.zoomTintImage.css("height", s),
              e.zoomTint.css("height", s)),
            e.zoomContainer.css({ height: s, width: n }),
            e.options.imageCrossfade && e.zoomWrap.css({ height: s, width: n });
        if (e.options.constrainType) {
          if ("height" === e.options.constrainType) {
            var l = { height: e.options.constrainSize, width: "auto" };
            e.zoomContainer.css(l),
              e.options.imageCrossfade
                ? (e.zoomWrap.css(l), (e.constwidth = e.zoomWrap.width()))
                : (e.$elem.css(l), (e.constwidth = n));
            var m = { height: e.options.constrainSize, width: e.constwidth };
            "inner" === e.options.zoomType &&
              (e.zoomWrap.parent().css(m), e.zoomWindow.css(m)),
              e.options.tint &&
                (e.tintContainer.css(m),
                e.zoomTint.css(m),
                e.zoomTintImage.css(m));
          }
          if ("width" === e.options.constrainType) {
            var w = { height: "auto", width: e.options.constrainSize };
            e.zoomContainer.css(w),
              e.options.imageCrossfade
                ? (e.zoomWrap.css(w), (e.constheight = e.zoomWrap.height()))
                : (e.$elem.css(w), (e.constheight = s));
            var g = { height: e.constheight, width: e.options.constrainSize };
            "inner" === e.options.zoomType &&
              (e.zoomWrap.parent().css(g), e.zoomWindow.css(g)),
              e.options.tint &&
                (e.tintContainer.css(g),
                e.zoomTint.css(g),
                e.zoomTintImage.css(g));
          }
        }
      },
      doneCallback: function () {
        ...
        "window" === this.options.zoomType) &&
          ((o =
            this.nzHeight < this.options.zoomWindowHeight / this.heightRatio
              ? this.nzHeight
              : String(this.options.zoomWindowHeight / this.heightRatio)),
          (i =
            this.nzWidth < this.options.zoomWindowWidth
              ? this.nzWidth
              : this.options.zoomWindowWidth / this.widthRatio),
          this.zoomLens && this.zoomLens.css({ width: i, height: o }));
      },
      ...
      changeZoomLevel: function (o) {
        ...
        "inner" !== this.options.zoomType &&
          (t <= i
            ? ((this.heightRatio = this.largeHeight / t / this.nzHeight),
              (this.newvalueheight = t),
              (this.fullheight = !0))
            : ((this.heightRatio = this.largeHeight / i / this.nzHeight),
              (this.newvalueheight = i),
              (this.fullheight = !1)),
          e <= i
            ? ((this.widthRatio = this.largeWidth / e / this.nzWidth),
              (this.newvaluewidth = e),
              (this.fullwidth = !0))
            : ((this.widthRatio = this.largeWidth / i / this.nzWidth),
              (this.newvaluewidth = i),
              (this.fullwidth = !1)),
          "lens" === this.options.zoomType &&
            (t <= i
              ? ((this.fullwidth = !0), (this.newvaluewidth = t))
              : ((this.widthRatio = this.largeWidth / i / this.nzWidth),
                (this.newvaluewidth = i),
                (this.fullwidth = !1)))),
          "inner" === this.options.zoomType &&
            (i >
              (t = parseFloat(this.largeHeight / this.nzHeight).toFixed(2)) &&
              (i = t),
            i > (e = parseFloat(this.largeWidth / this.nzWidth).toFixed(2)) &&
              (i = e),
            t <= i
              ? ((this.heightRatio = this.largeHeight / i / this.nzHeight),
                (this.newvalueheight = i > t ? t : i),
                (this.fullheight = !0))
              : ((this.heightRatio = this.largeHeight / i / this.nzHeight),
                (this.newvalueheight = i > t ? t : i),
                (this.fullheight = !1)),
        ...
        "inner" === this.options.zoomType &&
          (this.nzWidth >= this.nzHeight &&
            (this.newvaluewidth <= e
              ? (n = !0)
              : ((n = !1), (this.fullheight = !0), (this.fullwidth = !0))),
          this.nzHeight > this.nzWidth &&
            (this.newvaluewidth <= e
              ? (n = !0)
              : ((n = !1), (this.fullheight = !0), (this.fullwidth = !0)))),
          "inner" !== this.options.zoomType && (n = !0),
          n &&
            ((this.zoomLock = 0),
            (this.changeZoom = !0),
      ...
      closeAll: function () {
        this.zoomWindow && this.zoomWindow.hide(),
          this.zoomLens && this.zoomLens.hide(),
          this.zoomTint && this.zoomTint.hide();
      },
      changeState: function (o) {
        "enable" === o && (this.options.zoomEnabled = !0),
          "disable" === o && (this.options.zoomEnabled = !1);
      },
      responsiveConfig: function (i) {
        return i.respond && i.respond.length > 0
          ? o.extend({}, i, this.configByScreenWidth(i))
          : i;
      },

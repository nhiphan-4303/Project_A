(() => {
  var e = {
      875: (e, t) => {
        ...
        t.monorailSend = function (e, t, r) {
          if (
            window &&
            window.navigator &&
            "function" == typeof window.navigator.sendBeacon &&
            t.utils.isNative(window.navigator.sendBeacon) &&
            "function" == typeof window.Blob &&
            (!(o = window.navigator.userAgent) ||
              (-1 === o.lastIndexOf("iPhone; CPU iPhone OS 12_") &&
                -1 === o.lastIndexOf("iPad; CPU OS 12_")))
          ) {
            var i = new window.Blob([JSON.stringify(r)], {
              type: "text/plain",
            });
            try {
              if (window.navigator.sendBeacon(e, i)) return !0;
            } catch (e) {}
          }
          var o,
          ...
          try {
            ...
            n(e, (a = new t.boomerang_frame.XMLHttpRequest()), r);
          }
        };
        const r = "xxxx-4xxx-xxxx-xxxxxxxxxxxx";
        t.buildUUID = function () {
          let e = "";
          try {
        ...
        !(function (e) {
          ...
          var t,
            ...
            v = function (e) {
              "hidden" === document.visibilityState &&
                g > -1 &&
                ((g = "visibilitychange" === e.type ? e.timeStamp : 0), B());
            },
            _ = function () {
              ...
              (r = r || {}),
                R(function () {
                  var o,
                    ...
                    g = l("first-input", p);
                  (o = f(e, c, k, r.reportAllChanges)),
                    g &&
                      O(
                        m(function () {
                          p(g.takeRecords()), g.disconnect();
                        })
                      ),
                    g &&
                      s(function () {
                ...
                R(function () {
                  ...
                  var r,
                    ...
                    o = function (e) {
                      ...
                      var t,
                        n =
                          ((t = Math.min(H.length - 1, Math.floor(q() / 50))),
                          H[t]);
                      n &&
                        n.latency !== i.value &&
                  ...
                  var n,
                    ...
                    o = function (e) {
                      ...
                      t &&
                        ...
                        ((i.value = Math.max(t.startTime - u(), 0)),
                        (i.entries = [t]),
                        n());
                    },
                    a = l("largest-contentful-paint", o);
                  if (a) {
                    n = f(e, i, $, t.reportAllChanges);
                    var c = m(function () {
                      J[i.id] ||
                        (o(a.takeRecords()),
                        a.disconnect(),
            ...
            Z = function (e, t) {
              t = t || {};
              var n = d("TTFB"),
                r = f(e, n, Y, t.reportAllChanges);
              K(function () {
                var i = c();
                if (i) {
                  var o = i.responseStart;
                  if (o <= 0 || o > performance.now()) return;
                  (n.value = Math.max(o - u(), 0)),
                    (n.entries = [i]),
                    r(!0),
                    s(function () {
                      (n = d("TTFB", 0)),
                        (r = f(e, n, Y, t.reportAllChanges))(!0);
                    });
                }
              });
            };
  ...
  (() => {
          ...
          if (
            ...
            void 0 !== i.hidden
              ...
              : void 0 !== i.webkitHidden &&
                ((s = "webkitVisibilityState"), (c = "webkitvisibilitychange")),
            (n = {
              beacon_url: "",
            ...
            (r = {
              ...
              utils: {
                ...
                setLocalStorage: function (e, r, i) {
                  ...
                  if (
                    ...
                    try {
                      if (
                        (t.localStorage.setItem(n.LOCAL_STORAGE_PREFIX + e, a),
                        a ===
                ...
                removeLocalStorage: function (e) {
                  ...
                  try {
                    return (
                      t.localStorage.removeItem(n.LOCAL_STORAGE_PREFIX + e), !0
                    );
                  } catch (e) {}
                  return !1;
                },
                        ...
                        e.match(/^(https?|file):/)
                          ? (t && (e = e.replace(/#.*/, "")),
                            e.replace(/\?([^#]*)/, function (e, t) {
                              return (
                                "?" +
                                (t.length > 10 ? BOOMR.utils.hashString(t) : t)
                              );
                            }))
                ...
                generateId: function (e) {
                  return "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
                    ...
                    .replace(/x/g, function (e) {
                      return "0" === (e = (Math.random() || 0.01).toString(36))
                        ? "0"
                        : e.substr(2, 1);
                    });
                },
                ...
                if (
                  ...
                  if (
                    ...
                    if (e.stack) {
                      if (
                        ((c = e.stack.split("\n")[0]),
                        (!/boomerang\/shopify/.test(c) && /^https?/.test(c)) ||
                          /@https?/.test(c))
                      )
                        return;
              ...
              real_sendBeacon: function () {
                ...
                if (
                  !(window && window.Image && window.navigator && BOOMR.window)
                )
                  return !1;
    ...
    (() => {
      var { onCLS: e, onFID: t, onINP: r } = n(511),
        i = {
      ...
      !(function () {
        (BOOMR = window.BOOMR || {}), (BOOMR.plugins = BOOMR.plugins || {});
        var n = function (e) {
          BOOMR.addVar(i[e.name], e.value, !0);
        };
        BOOMR.plugins.CoreWebVitals = {
          init: function () {
            return e(n), t(n), r(n), this;
          },
          is_complete: function () {
            return !0;
          },
    ...
    (function () {
      ...
      if (
        ...
        (e = {
          ...
          (BOOMR.plugins.ResourceTiming = {
            ...
            getCompressedResourceTiming: S,
            getFilteredResourceTiming: M,
      ...
      function m(t, n) {
        ...
        for (r in t) {
          for (o = r, a = 0; a < e.xssBreakWords.length; a++)
            o = o.replace(e.xssBreakWords[a], "$1" + i + "$2");
      ...
      function g(e, t) {
        ...
        for (var c = 0; c < s.length; c++)
          "object" == typeof e[(n = s[c])] &&
            (r = g(e[n], !1)) &&
            (delete e[n],
            n === i ? ((n = r.name), a++) : (n += r.name),
            (e[n] = r.value)),
            a++;
        return 1 === a
          ? t
      ...
      function y(t, i, o, a, s) {
        ...
        try {
          ...
          if (
            ...
            R((S = t.document.createElement("a")), x, "script"),
            R(S, C, "link"),
            (g = t.document.getElementsByTagName("iframe")) && g.length)
          )
            for (c = 0; c < g.length; c++)
              (O = B(g[c].contentWindow)),
                (m = 0),
                O > p && (m = o + (O - p)),
                (S.href = g[c].src),
                (T = T.concat(y(g[c].contentWindow, !1, m, a + 1, w[S.href])));
          if ("function" != typeof t.performance.getEntriesByType) return T;
          function P(t) {
            return (e.serverTiming && t.serverTiming) || [];
          }
          i &&
            ((f = t.performance.getEntriesByType("navigation")) &&
            1 === f.length
              ? ((v = f[0]),
                T.push({
                  ...
                  startTime: 0,
                  initiatorType: "html",
                  redirectStart: v.redirectStart,
                  redirectEnd: v.redirectEnd,
                  ...
                  workerStart: v.workerStart,
                  encodedBodySize: v.encodedBodySize,
                  decodedBodySize: v.decodedBodySize,
                  transferSize: v.transferSize,
                  serverTiming: P(v),
                }))
              : t.performance.timing &&
                0 !== (b = t.performance.timing).navigationStart &&
                b.responseEnd <= b.navigationStart + 36e5 &&
                T.push({
                  name: t.location.href,
                  startTime: 0,
                  initiatorType: "html",
                  redirectStart: b.redirectStart
                    ? b.redirectStart - b.navigationStart
                    : 0,
                  redirectEnd: b.redirectEnd
                    ? b.redirectEnd - b.navigationStart
                    : 0,
                  fetchStart: b.fetchStart
                    ? b.fetchStart - b.navigationStart
                    : 0,
                  domainLookupStart: b.domainLookupStart
                    ? b.domainLookupStart - b.navigationStart
                    : 0,
                  domainLookupEnd: b.domainLookupEnd
                    ? b.domainLookupEnd - b.navigationStart
                    : 0,
                  connectStart: b.connectStart
                    ? b.connectStart - b.navigationStart
                    : 0,
                  secureConnectionStart: b.secureConnectionStart
                    ? b.secureConnectionStart - b.navigationStart
                    : 0,
                  connectEnd: b.connectEnd
                    ? b.connectEnd - b.navigationStart
                    : 0,
                  requestStart: b.requestStart
                    ? b.requestStart - b.navigationStart
                    : 0,
                  responseStart: b.responseStart
                    ? b.responseStart - b.navigationStart
                    : 0,
                  responseEnd: b.responseEnd
                    ? b.responseEnd - b.navigationStart
                    : 0,
                }));
          var L = t.performance.getEntriesByType("resource"),
            k = [];
          t === BOOMR.window &&
            e.collectedEntries &&
            (Array.prototype.push.apply(L, e.collectedEntries),
            (e.collectedEntries = []));
          var A = 0;
          for (c = 0; L && c < L.length; c++)
            if (((b = L[c]), !(A >= 10 && h(b)))) {
              M = {
                name: b.name,
                initiatorType: b.initiatorType,
                encodedBodySize: b.encodedBodySize,
                decodedBodySize: b.decodedBodySize,
                transferSize: b.transferSize,
                serverTiming: P(b),
                visibleDimensions: w[b.name],
                latestTime:
                  ((E = b),
                  E.responseEnd
                    ? E.responseEnd
              ...
              for (var I = 0; I < r.length; I++) {
                var V = r[I];
                M[V] = "startTime" === V || b[V] ? b[V] + o : 0;
              }
              if (
                (b.hasOwnProperty("_data") && (M._data = b._data),
                ("script" === b.initiatorType || "link" === b.initiatorType) &&
                  x[b.name])
              ) {
                var N = x[b.name];
                for (
                  M.scriptAttrs = (N.async ? u : 0) | (N.defer ? d : 0);
                  1 === N.nodeType && "BODY" !== N.nodeName;

                )
                  N = N.parentNode;
                M.scriptAttrs |= "BODY" === N.nodeName ? l : 0;
              }
      ...
      function S(n, r) {
        var i,
          ...
          E = {},
          T = {},
          x = M(n, r, e.trackedResourceTypes).entries;
        if (!x || !x.length) return { resource_timing: {} };
        for (i = 0; i < x.length; i++) {
          (u = x[i]),
            void 0 === (d = t[u.initiatorType]) && (d = 0),
            (h =
              d +
              [
                v(u.startTime, 0),
                v(u.responseEnd, u.startTime),
                v(u.responseStart, u.startTime),
                v(u.requestStart, u.startTime),
                v(u.connectEnd, u.startTime),
                v(u.secureConnectionStart, u.startTime),
                v(u.connectStart, u.startTime),
                v(u.domainLookupEnd, u.startTime),
                v(u.domainLookupStart, u.startTime),
                v(u.redirectEnd, u.startTime),
                v(u.redirectStart, u.startTime),
              ]
                .map(b)
                .join(",")
                .replace(/,+$/, ""));
          var C =
            ...
            (R = void 0),
            (S = void 0),
            (B = u).encodedBodySize || B.decodedBodySize || B.transferSize
              ? ((y = B.transferSize),
                [
                  (R = B.encodedBodySize),
                  y ? y - R : "_",
                  (S = B.decodedBodySize) ? S - R : 0,
                ]
                  .map(b)
                  .join(",")
                  .replace(/,+$/, ""))
          ...
          if (
            ("" !== C && (h += o + s + C),
            u.hasOwnProperty("scriptAttrs") && (h += o + c + u.scriptAttrs),
            u.hasOwnProperty("linkAttrs") && (h += o + f + u.linkAttrs),
            u.workerStart &&
              "number" == typeof u.workerStart &&
              0 !== u.workerStart)
          ) {
            var P = v(
              ("number" != typeof (_ = u.workerStart) && (_ = 0),
              Math.ceil(_ || 0)),
              u.startTime
            );
            h += o + O + b(P);
          }
          if (((l = w(u.name, e.trimUrls)), u.hasOwnProperty("_data"))) {
            var L = "";
            for (var k in u._data)
              u._data.hasOwnProperty(k) && (L += o + p + k + ":" + u._data[k]);
            void 0 === E[l] ? (E[l] = h + L) : (E[l] += L);
          } else
            void 0 !== E[l]
              ? (E[l] += "|" + h)
              : u.visibleDimensions
              ...
              : (E[l] = h);
          u.visibleDimensions &&
            (T[u.latestTime] || (T[u.latestTime] = []),
            T[u.latestTime].push(u.visibleDimensions));
        }
        return { resource_timing: g(m(E, e.splitAtPath), !0) };
      }
      function E(e) {
        var t = [];
    ...
    (function () {
      ...
      var e = {
        setShopifyIdentifiers: function () {
          try {
            var t = (BOOMR.window.document || document).cookie.match(
              /_shopify_y=([^;]*)/
            );
            t && t.length > 1 && BOOMR.addVar("session_token", t[1]);
          } catch (e) {}
          if (BOOMR.themeId && BOOMR.shopId)
      ...
      !(function () {
        if (
          ...
          var n = {
            ...
            onBeacon: function (r) {
              if (n.can_send && !n.did_send) {
                var i = {
                  schema_id: "boomerang_real_user_measurement_audit/7.2",
                  payload: r,
                  metadata: {
                ...
                (n.did_send = !0), e(n.producer_url, BOOMR, i);
              }
            },
          };
          BOOMR.plugins.MonorailProducer = {
            init: function () {
              if (!n.initialized) {
                var e = BOOMR.window || window;
                BOOMR.subscribe("before_beacon", n.onBeacon, null, n),
                  BOOMR.subscribe("config", function (e) {
                    e.producer_url && (n.producer_url = e.producer_url);
                  }),
                  e.addEventListener("pagehide", function () {
                    (n.can_send = !0), BOOMR.sendBeacon();
                  }),
                  e.addEventListener("visibilitychange", function () {
                    "hidden" === e.document.visibilityState &&
                      ((n.can_send = !0), BOOMR.sendBeacon());
                  }),
                  (n.initialized = !0);
              }

!(function () {
  ...
  e(function (e, a) {
    ...
    function s(e, t) {
      ...
      var o = u({ referer: window.location.href }, r);
    ...
    var y,
      ...
      p = (function () {
        ...
        return (
          t(e, null, [{ key: "handleXhrOpen", value: function () {} }]),
          t(
            e,
            [
              {
          ...
          if (
            ...
            if (t && (t.getAttribute("action") || t.getAttribute("href")))
              try {
                ...
                var c = u({ cartToken: a }, i),
                  s = u({ referer: window.location.href }, i);
        ...
        function i(e, t) {
          ...
          try {
            for (
              ...
              var s = o.value,
                d = c(e, s);
              if (d) return { product: s, variant: d };
            }
          } catch (e) {
            (r = !0), (a = e);
          } finally {

!(function () {
  ...
  function oe() {
    if (null !== ee) {
      if (se() && re.size > 0) {
        let e = {};
        for (const t of re) e = { ...e, ...t };
        re.clear(), (ee.info.microSessionCount += 1);
        const t = (function (e) {
  ...
  (ie = function (e) {
        ...
        (t = t || {}),
          _(function () {
            ...
            if (a) {
              ...
              var g = p(function () {
                z[o.id] ||
                  (i(a.takeRecords()), a.disconnect(), (z[o.id] = !0), n(!0));
              });
    ...
    (function (e, r) {
      ...
      const { value: t } = e;
      re.add({ firstContentfulPaint: Math.round(t) });
    }),
    (function (e, t) {
      !(function (e, t) {
        (t = t || {}),
          _(function () {
            ...
            var r,
              ...
              i = function (e) {
                ...
                var t,
                  n =
                    ((t = Math.min(N.length - 1, Math.floor(R() / 50))), N[t]);
                n &&
                  n.latency !== o.value &&
            ...
            (r = f(e, o, P, t.reportAllChanges)),
              a &&
                ...
                m(function () {
                  i(a.takeRecords()),
                    o.value < 0 && R() > 0 && ((o.value = 0), (o.entries = [])),
                    r(!0);
                }),
                s(function () {
                  (N = []),
    ...
    (function (e, t) {
      ...
      const { value: t } = e;
      re.add({ timeToFirstByte: Math.round(t) });
    }),
        ...
        (t = (function (e) {
          ...
          if (
            ...
            (isNaN(Number(e.resourceTimingSamplingRate)) ||
              Number(e.resourceTimingSamplingRate) < H ||

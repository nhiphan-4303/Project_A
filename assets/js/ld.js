!(function () {
  ...
  var I,
    ...
    u =
      (((P = I = I || {})[(P.None = 0)] = "None"),
      (P[(P.Cookie = 1)] = "Cookie"),
      (P[(P.LocalStorage = 2)] = "LocalStorage"),
      (P[(P.Library = 3)] = "Library"),
      (o.checkLocalStorageIsWritable = function () {
        try {
          var e;
          return window.localStorage
            ? ((e = "criteo_localstorage_check"),
      ...
      (o.prototype.setValueFromExistingCookie = function () {
        ...
        void 0 !== e &&
          ((this.cookieValue = e),
          (this.cookieExtractor = { origin: I.Cookie }));
      }),
        ...
        switch (this.cookieExtractor.origin) {
          case I.LocalStorage:
            return {
              ...
              identifierExtractor: { origin: I.LocalStorage },
            };
          case I.Cookie:
            return {
              value: this.getValue(),
              identifierExtractor: { origin: I.Cookie },
            };
          case I.Library:
            return {
              value:
                null == (e = (t = this.cookieExtractor).retrievalMethod)
                  ? void 0
                  : e.call(t),
              identifierExtractor: {
                origin: I.Library,
      ...
      (o.prototype.setOnMainDomainWithExpiration = function (e, t) {
        for (
          var n = new Date(),
            o = (n.setTime(n.getTime() + t), "expires=" + n.toUTCString()),
            i =
  ...
  var _,
    ...
    W =
      ...
      (r.log = function (e, t, n) {
        t <= r.level &&
          ((t =
            0 < (t = window.navigator.userAgent).indexOf("MSIE ") ||
            0 < t.indexOf("Trident/")
              ? ["[" + i + "]"]
              : ["%c" + i, S]),
          e.apply(console, t.concat(n)));
      }),
      (r.level = _.Warning),
      r);
  function r() {}
  ((P = t = t || {})[(P.Unknown = 0)] = "Unknown"),
    (P[(P.TopLevel = 1)] = "TopLevel"),
    (P[(P.Child = 2)] = "Child");
  (a.extractHostname = function (e) {
    ...
    (a.getAnchorWithReferrer = function (e) {
      var t;
      return e && e.referrer
        ? (((t = e.createElement("a")).href = e.referrer), t)
        : null;
    }),
    ...
    (a.getPreviousUrl = function (e) {
      ...
      return (
        (n = e.err
          ? n
          : t.document.referrer ||
            (null == (e = t.top) ? void 0 : e.document.referrer) ||
            "") ||
          ((t = null == (e = t.location) ? void 0 : e.ancestorOrigins) &&
            0 < t.length &&
            (n = t[t.length - 1])),
        n
      );
      ...
      if ("complete" === document.readyState) o();
        ...
        e && e.doScroll
          ...
          : ((t = !1),
            ...
            (document.onload = document.onreadystatechange =
              function (e) {
  ...
  (l.prototype.preload = function () {
    ...
    (l.prototype.onUserIdAvailable = function (i, r) {
      function a(e) {
        var t, n, o;
        c ||
          ((t = e * l.retryIntervalMs),
          void 0 !== (n = s.instance())
            ? ((c = !0),
              (o = Math.max(r - t, 0)),
              s.logger(
                "instance available after waiting (ms):",
                t,
                "allowing for user id to be available more (ms):",
                o
              ),
              n.onAvailable(function (e) {
                e = e.getUserId();
                return s.logger("user ID available:", e), i(e);
              }, o))
            : r <= t
            ? ((c = !0),
              s.logger("timeout waiting for instance after waiting (ms):", t),
              i(void 0))
            : (s.exceptionHandler.setProtectedTimeout(function () {
                return a(e);
              }, l.retryIntervalMs),
              e++));
      }
    ...
    (l.prototype.instance = function () {
      var e;
      return (
        void 0 === this._instance &&
          window.hasOwnProperty("Criteo") &&
          null != (e = window.Criteo) &&
          e.hasOwnProperty("ID5") &&
          (this._instance = window.Criteo.ID5.init({
      ...
      (e = "https://cdn.id5-sync.com/api/1.0/id5-api.js"),
        ...
        (n = function () {
          (window.Criteo = window.Criteo || {}),
            (window.Criteo.ID5 = i.contentWindow.ID5);
        }),
        ((o = document.createElement("script")).src = e),
        (o.type = "text/javascript"),
        (o.onload = n),
        null != (e = t.contentWindow) && e.document.head.appendChild(o),
        this.preload();
    }),
    (l.criteoPartnerId = 203),
    (l.retryIntervalMs = 100),
    (l.maxWaitForApiMs = 2e4);
  var G = l;
  function l() {
    (this.logger = function () {
      for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
      return W.debug.apply(
        W,
        (function () {
        ...
        this.currentWindow.addEventListener(
          ...
          function (e) {
            ...
            e &&
              ...
              ((e = e.__cmpReturn), i.cmpCallbacks) &&
  ...
  ((P = d = d || {}).LOADED = "tcloaded"),
    (P.UI_SHOWN = "cmpuishown"),
    (P.USER_ACTION_COMPLETE = "useractioncomplete"),
    ...
    (p.prototype.retrieveConsent = function (n) {
      ...
      this.executeCommand("addEventListener", 2, function (e, t) {
        clearTimeout(c),
          a ||
            ((i = e.eventStatus) !== d.UI_SHOWN && clearTimeout(s),
            t
              ? (r.logger("TCFv2 consent retrieved in ms"),
                ...
                ((!1 === e.gdprApplies && void 0 === i) ||
                  i === d.LOADED ||
                  i === d.USER_ACTION_COMPLETE) &&
                  n(o))
        ...
        (this.currentWindow.__tcfapi = function (e, t, n, o) {
          i
            ? ((t = {
              ...
              (r.cmpCallbacks[e] = n),
              i.postMessage(t, "*"))
            : (r.logger("TCFv2 CMP not found in any frame"),
        ...
        this.currentWindow.addEventListener(
          ...
          function (e) {
            ...
            e &&
              ...
              ((e = e.__uspapiReturn), i.uspapiCallbacks) &&
              i.uspapiCallbacks[e.callId] &&
              (i.uspapiCallbacks[e.callId](e.returnValue, e.success),
              delete i.uspapiCallbacks[e.callId]);
          },
          !1
        )),
  ...
  f.prototype.retrieveConsent = function (t) {
    var n,
      e = this.tcfCompatibleConsentProvider.readyToRetrieve(),
  ...
  function f(e, t, n, o, i) {
    (t = {
      ...
      (n = { uspApiTimeout: (i = void 0 === i ? 500 : i) });
    (this.tcfCompatibleConsentProvider = new F(
      new E(e, t, W.info),
      new x(e, t, W.info),
      W.info
    )),
      (this.ccpaConsentProvider = new M(e, n, W.info));
  }
  function A(e, t) {
    if (e instanceof Array)
      for (var n = 0, o = e; n < o.length; n++) A(o[n], t);
    else V(t, e) || t.push(e);
  }
  function V(e, t) {
    for (
  ...
  function j(e, t) {
    if (void 0 !== e || void 0 !== t) {
      ...
      for (var n = 0, o = e; n < o.length; n++) if (!V(t, o[n])) return !1;
    }
    return !0;
  }
  function B(e) {
  ...
  (g.prototype.fillQueryStringParams = function (e, t) {
    ...
    n && e.push("fpid=" + n),
      ...
      void 0 !==
        new u("cto_clc", this.readonlyCookieRetentionTime).getValue() &&
        e.push("clc=1");
  }),
      ...
      if (e.callbacks) {
        for (
          ...
          i.parentNode.insertBefore(r, i),
            N.removeLater(this.exceptionHandler, r);
        }
        t = !1;
      }
      e.optout
    ...
    (g.prototype.getParameterValueByName = function (e, t) {
      if (e && 1 < e.length) {
        ...
        if (-1 !== o)
          return (
            (n = e.indexOf("&", o + t.length)),
            e.slice(o + t.length, n < 0 ? void 0 : n)
          );
      }
      return null;
    }),
  ...
  function g(e, t, n, o) {
    (this.readonlyCookieRetentionTime = 0),
      ...
      (this.secureIdCookie = new u(
        "cto_sid",
        this.identificationCookieRetentionTime
      )),
      (this.bundleCookie = new u(
        "cto_bundle",
        this.identificationCookieRetentionTime
      )),
      (this.ifaCookie = new u(
        "id_controller_ifa",
        this.identificationCookieRetentionTime
      )),
      (this.socialCookie = new O()),
  ...
  (m.prototype.fillQueryStringParams = function (e, t) {}),
    (m.prototype.checkAcid = function () {}),
    (m.prototype.setCop = function (e) {}),
    (m.prototype.checkClientSideIdentityStatus = function () {}),
    (m.prototype.checkCookies = function (e) {}),
    (m.prototype.scrapIdentifiers = function (e) {
      return "";
    });
  var K = m;
  function m() {
    (this.secureIdCookie = new u("empty", 0)),
  ...
  (y.prototype.createIframe = function (e, t, n, o, i) {
      ...
      a =
        (e &&
          (void 0 !== e.gdprApplies &&
            (o += "&gdpr=" + (e.gdprApplies ? 1 : 0)),
          void 0 !== e.consentData) &&
          (o += "&gdpr_consent=" + e.consentData),
        i.ccpaConsent);
    return (
      a && void 0 !== a.uspString && (o += "&us_privacy=" + a.uspString),
      (o += "#" + JSON.stringify(t)),
      (r.src = o),
    ...
    (y.prototype.shouldInjectSyncframe = function () {
      return (
        (void 0 !== window.addEventListener || this.forceSyncFrame) &&
  ...
  function y(e) {
    (this.forceSyncFrame = !1),
      (this.gumSyncFrameOrigin = "https://" + v("gumDomain", "gum.criteo.com")),
      ...
      (this.waitingForSyncframe = e.hasItp || v("waitForGum", !0)),
      (this.enableOffsiteProjection = v("enableOffsiteProjection", !0));
  }
  (C.prototype.createIframe = function (e, t, n, o, i) {
    return document.createElement("iframe");
  }),
    (C.prototype.setWaitingFlag = function (e) {}),
    (C.prototype.shouldInjectSyncframe = function () {
      return !1;
    });
  var X = C;
  function C() {
  ...
  var Z = new RegExp(
    ...
    ee =
      ((w.prototype.canRetrieveMetrics = function () {
  ...
  (b.prototype.trySetPageId = function (e, t) {
    ...
    (b.prototype.tryRunActionAfterAdBlockDetectionOrImmediate = function (
      t,
      e
    ) {
      var n = this,
        o = window.criteo_q;
      null != o && ((o = o.adBlockDetector), this.isCbsEnabled) && void 0 !== o
        ? (o(function (e) {
            (n.abe = e), t();
          }),
          e(t))
    ...
    (b.prototype.tryAppendUatParameter = function (e) {
      ...
      this.isCbsEnabled &&
        void 0 !== this.uat &&
        ((t = encodeURIComponent || escape), e.push("uat=" + t(this.uat)));
    }),
  ...
  function b() {
    (this.abe = void 0),
      (this.isCbsEnabled = !1),
      (this.uat = void 0),
      (this.shouldFillPageId = v("shouldFillPageId", !0));
  }
  ...
  function ne(e, t, n, o, i) {
    ...
    return (
      document &&
        ...
        (a = U.exec(window.location.hash)) &&
        4 === a.length &&
        ((r = "enable" === a[1]),
        (a = Number(a[3])),
        new u("criteoTagDebugMode", r ? 864e5 : 0).setValueWithNoDomain(
          r && a && !isNaN(a) ? String(a) : "0"
        ),
        ...
        ? ((s = i),
          ...
          (window.onerror = (function (i) {
            return function (e, t, n, o) {
              return (
                c.pushError({ column: o, lineNumber: n, message: e, url: t }),
          ...
          document &&
            ...
            i.setAttribute(
              "src",
              document.location.protocol + "//static.criteo.net/js/ld/" + a
            ),
            (a =
              document.getElementsByTagName(
                "script"
              )[0]).parentNode.insertBefore(i, a)),
          r)
        : e
    );
  }
  function oe(t, n) {
    function e(e) {
      void 0 === e && (e = !1),
        n.eventSent ||
          (e && t({ event: "setRequestType", type: "beacon" }),
          t({ event: "viewPage" }));
    }
  ...
  (k.prototype.registerTrigger = function (e) {
    var t;
    this.isFeatureAllowed("attribution-reporting") &&
      ...
      t.setAttribute(
        "attributionsrc",
        k.ATTRIBUTION_TRIGGER_URL_PREFIX + "?" + e
      ),
      (e = document.getElementsByTagName("script")[0]),
      t.setAttribute("data-owner", "criteo-tag"),
      e.parentNode.insertBefore(t, e),
      N.removeLater(this.exceptionHandler, t));
  }),
  ...
  function ce() {
    void 0 !==
      (null ==
      (u = null === window || void 0 === window ? void 0 : window.location)
        ? void 0
        : u.hash) &&
      -1 !== window.location.hash.indexOf("onetag-debug") &&
      W.setLogLevel(_.Debug);
    var e,
      n,
      t,
      o,
      ...
      C =
        ...
        (u = {
          ...
          customerInfo: [],
          extraData: [],
          handlerParams: { v: T, otl: N.getOneTagLocation() },
        ...
        (l = {
          externalIdentifiersToRead: {
            FirstId: { key: "firstid", storageSource: { origin: I.Cookie } },
            IntimateMergerId: {
              key: /^_im_uid\./,
              storageSource: { origin: I.LocalStorage },
            },
          },
        }),
        v("addClientSideSupportForId5") &&
          ((e = new G()).initialize(),
          (l.externalIdentifiersToRead.Id5 = {
            key: "id5",
            storageSource: {
              origin: I.Library,
      ...
      l =
        ...
        (i = null !== (d = d.match(Z))),
        { hasItp: null !== d && 11 <= parseFloat(d[1]), isSafari: i }),
      w = u ? new Y(F, l, window, C) : new K(),
      b = u ? new $(l) : new X(),
      d = new H(window),
      E = new ie(document, F),
      x =
        ((r = d.retrieveConsent.bind(d)),
        (a = !1),
        (s = void 0),
        (c = []),
        function (e) {
    ...
    function S(e, t, n, o, i, r, a, s, c, u, l) {
      e.waitingForSyncframe &&
        ((e.waitingForSyncframe = !1), m(e, t, n, o, i, r, a, s, c, u, l));
    }
    function f(h, f, g, m, v, y, C, w, b, k, P, e) {
      h.shouldInjectSyncframe() &&
        ((e = h.createIframe(
          m,
          w.tagVersion,
          F,
          w.privateModeDetectionEnabled,
          e
        )),
        window.addEventListener) &&
        (F.addProtectedEventListener(
          window,
          "message",
          function (e) {
            ...
            (t = h),
              ...
              (l = k),
              (d = P),
              (((p = (e = e).data) && e.origin == t.gumSyncFrameOrigin) ||
                window.BypassSyncframeMessageSanityCheck) &&
                (e.stopPropagation(),
                i.checkCookies(p),
                t.waitingForSyncframe) &&
                S(t, n, o, i, r, a, s, c, u, l, d);
          },
          !0
        ),
        O(f, k, b, { event: "appendtag", element: e }));
    }
    function p(e, t) {
      var n = e.extraData,
        o = !1;
      if (200 < n.length) o = !0;
        ...
        for (var i = 0, r = n; i < r.length; i++) {
          ...
          if (Object.keys) s = Object.keys(a).length;
            ...
            for (var c in a)
              Object.prototype.hasOwnProperty.call(a, c) && (s += 1);
          if (200 < s) {
            o = !0;
            break;
          }
    ...
    function g() {
      ...
      F.catchAndStoreException(function () {
        ...
        m(
          ...
          C.hooks,
          C.workflow,
          C.identifierScrappingConfig
        ),
          p(C.trackingCallData, y.cbs),
          h.stopRecordingPush();
      }, n),
        h.stopRecordingInit();
    }
    function m(e, t, n, o, i, r, a, s, c, u, l) {
      for (var d = [], p = t.queue, h = 0; h < p.length; ++h) {
        var f = p[h];
        if (
          (f instanceof Array && p.splice.apply(p, [h + 1, 0].concat(f)),
          f instanceof Function)
        )
          p.splice(h + 1, 0, f());
        else if (f && "[object Object]" === f.toString())
          switch (
            (function (e, t, n, o, i, r, a, s, c, u, l, d, p, h) {
              var f = l.event,
                g = L(e, l);
              if (null !== g) return g;
              switch (l.event) {
                ...
                case "setidentity":
                  if (l.hasOwnProperty("identity"))
                    if (
                      ...
                      (v = R(
                        (v =
                          l.identity instanceof Array
                            ? l.identity
                            : [l.identity])
                      )).length
                    )
                      return (l.identity = v), e.actions.push(B(l)), 1;
                  return 0;
                case "setsitetype":
                  v = "d";
                  return (
                    ("aios" !== l.type && "aa" != l.type) || (v = l.type),
                    ("mobile" !== l.type && "m" !== l.type) || (v = "m"),
                    ("tablet" !== l.type && "t" !== l.type) || (v = "t"),
                    (l.event = "setdata"),
                    delete l.type,
                    (l.site_type = v),
                    q(a.extraData, e.actions, l)
                ...
                case "appendtag":
                  return k(e, c, s, l);
                case "gettagstate":
                  return l.callback instanceof Function
                    ? l.callback(y, C, w, b)
                    : 1;
                case "setuat":
      ...
      c.afterEval instanceof Function && c.afterEval(),
        (t.queue = d || []),
        u.manualFlush ||
          (u.noPartialFlush && 0 !== t.queue.length) ||
          e.waitingForSyncframe ||
          P(t, n, o, i, r, a, s, c, u, l, 0 !== t.queue.length);
    }
    function M(e, t, n) {
      n.hasOwnProperty("account") || (n.account = t.accounts);
      e = e.handlerResponseType;
      n.hasOwnProperty("type") && ((e = n.type), delete n.type),
        A(n.account, t.disingScheduled),
        "sequential" === e && (n.dc = !0);
    }
    function O(e, t, n, o) {
      var i = L(e, o);
    ...
    function k(e, t, n, o) {
      if (
        (!e.bodyReady ||
          ...
          (t.container = N.appendCriteoContainer(document.body)),
        o.url &&
          ((e = void 0),
          o.isImgUrl
        ...
        if (
          ...
          o.element.setAttribute("data-owner", "criteo-tag"),
            e.parentNode.insertBefore(o.element, e);
        }
    ...
    function L(e, t) {
      return !e.domReady && t.requiresDOM && "no" !== t.requiresDOM
        ...
        : (delete t.requiresDOM,
          t.event
            ? (t.account && A(t.account, e.accounts),
      ...
      if (
        ...
        for (var v, y, C, w = 0, b = n.actions; w < b.length; w++) {
          ...
          (v = void 0) !== (k = k).identity &&
            JSON.stringify &&
            ((v = k.identity instanceof Array ? k.identity : [k.identity]),
            (k.raw_identity = JSON.stringify(v)),
            delete k.identity);
        }
        if (!c.manualDising && (!l || c.partialDis)) {
          ...
          0 < P.length &&
            ((l = a),
            null === L((y = n), (C = { event: "callDising", account: P }))) &&
        ...
        var _ = !1,
          D = (function (e, t, n, o, i, r, a, s) {
            ...
            "js" !== i.responseType &&
              u.push("rt=" + U(o, r, a, i.responseType, []));
            i.handlerParams &&
              (e = decodeURIComponent(U(o, r, a, i.handlerParams, []))) &&
              u.push(e);
            e = (function () {
              for (
            ...
            void 0 !== e &&
              ((p = encodeURIComponent || escape), u.push("csp-nonce=" + p(e)));
            ...
            for (var l = 0; l < c.length; ++l) {
              ...
              d.account &&
                j(
                  ...
                  null === d.account ? void 0 : d.account
                ) &&
                delete d.account,
                u.push("p" + l + "=" + U(o, r, a, d, []));
            }
            n.fillQueryStringParams(u, i),
              null !== i.partnerPayload &&
                u.push("pp=" + U(o, r, a, i.partnerPayload, []));
            i.dynamic && u.push("dy=1");
            ue(
              N.getHighestAccessibleUrl(window),
              u,
              i.fullUrlMaxLength,
              "fu",
              "ful"
            ),
              i.isStepAllowed("readPreviousUrl") &&
                ue(
                  N.getPreviousUrl(window),
                  u,
            ...
            0 < p.length &&
              u.push("external_advids=" + encodeURIComponent("[" + p + "]"));
            return u;
          })(n, o, e, t, a, i, r, u),
          A =
            ((n.actions = []),
            function () {
              ...
              _ ||
                ((_ = !0),
                o.tryAppendAdBlockerParameter(D),
                (e = D.join("&")),
                (t = {
                  event: "appendTag",
                ...
                "function" == typeof s.onUrlGenerated
                  ? s.onUrlGenerated(t.url)
                  : "beacon" === a.requestType && navigator.sendBeacon
                  ? navigator.sendBeacon(t.url)
                  : O(n, c, s, t),
                W.info("DIS call triggered", t.url, D),
                (n.eventSent = !0) === t.isImgUrl && E.registerTrigger(e),
                c.disOnce) ||
                (n.disingScheduled = []);
            }),
          R = function () {
            a.isStepAllowed("readCmaTestLabel") &&
        ...
        x(function (e) {
          ...
          D.push.apply(
            ...
            (n = (e = e).gdprConsent) &&
              ...
              void 0 !== n.version) &&
              t.push("grv=" + n.version),
            (n = e.ccpaConsent) &&
              (void 0 !== n.uspString && t.push("cs=" + n.uspString),
              void 0 !== n.version) &&
              t.push("cv=" + n.version),
            t)
          ),
            o.tryRunActionAfterAdBlockDetectionOrImmediate(R, function (e) {
    ...
    function U(e, t, n, o, i) {
      ...
      if (o instanceof Function) d = U(e, t, n, o(), i);
        ...
        for (f in o)
          o.hasOwnProperty(f) &&
            ...
            m.push(
              ...
              (c = f),
              (u = (u = g).join(".")),
              (s.properties[u] || c) + "=" + U(e, t, n, o[f], g))
            ));
        d += m.join("&");
      } else if (1 === i.length && "event" === i[0])
        d += e.events[o.toLowerCase()] ? e.events[o.toLowerCase()] : o;
      else {
        (v = n), (a = o), (r = (r = i).join("."));
        var v =
          "string" == typeof a &&
          v.shouldParseField(r) &&
          0 != a.length &&
          "[" == a.charAt(0) &&
          "]" == a.charAt(a.length - 1)
            ? a
        ...
        (r = t),
          (a = (a = i).join(".")),
          r.shouldEncodeField(a) ? (d += l(o)) : (d += o);
      }
      return l(d);
    }
    return F.catchAndStoreException(function () {
      w.checkAcid(),
        w.checkClientSideIdentityStatus(),
        w.setCop(window),
        (e = b),
        (t = y.app),
        (n = y.cbs),
        ...
        (r = C.encodingConfig),
        (a = C.parsingConfig),
        (s = C.trackingCallData),
        (c = C.hooks),
        (u = C.workflow),
        (l = C.identifierScrappingConfig),
        e.setWaitingFlag(o),
        e.waitingForSyncframe &&
          F.setProtectedTimeout(function () {
            S(e, t, n, o, i, r, a, s, c, u, l);
          }, 1e4),
        N.onBodyReady(F, function () {
          C.hooks.onInitialized instanceof Function
            ? ((y.app.bodyReady = C.hooks.onInitialized()),
              W.warn(
        ...
        N.onDocumentReady(F, function () {
          C.hooks.onDOMReady instanceof Function
            ? ((y.app.domReady = C.hooks.onDOMReady()),
              W.warn(
      ...
      var e,
        ...
        u,
        l,
        d = C.trackingCallData.extraData;
      try {
        var p = N.getAnchorWithReferrer(document);
        p &&
          p.hostname !== document.location.hostname &&
          Q(d, { event: "setData", ref: p.protocol + "//" + p.hostname });
      } catch (e) {}
      return (
        v("visitEventEnabled", !1) && oe(g, y.app),
        ne(
          {
  ...
  function ue(e, t, n, o, i) {
    ...
    e &&
      0 !== (e = e.trim()).length &&
      (n < (e = (r = encodeURIComponent || escape)(e)).length &&
        (t.push(i + "=" + e.length), (e = e.substr(0, n))),
      (i = r(e)),
      t.push(o + "=" + i));
  }
  (!window.criteo_q || window.criteo_q instanceof Array) &&
    ((P = window.criteo_q || []),
    (window.criteo_q = ce()),
    P.adBlockDetector,
    (window.criteo_q.adBlockDetector = P.adBlockDetector),
    (re = window.criteo_q).push.apply(re, P));
})();

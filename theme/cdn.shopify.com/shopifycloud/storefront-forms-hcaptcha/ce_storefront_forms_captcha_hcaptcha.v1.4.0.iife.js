!function () {
    ...
    const n = "form_key",
        e = ["recaptcha-v3-token", "g-recaptcha-response", "h-captcha-response", "password"],
        s = () => {
            try {
        ...
        o = function (n) {
            let e;
            return () => e || (e = new Promise(((n, s) => new Promise(((n, e) => {
                const s = `__shopify_hcap_load_${t(8)}`,
                    a = `https://js.hcaptcha.com/1/api.js?render=explicit&recaptchacompat=off&onload=${s}`,
                    o = setTimeout((() => {
                        window.hcaptcha ? (console.warn("hCaptcha already loaded - was the script downloaded more than once?"), n(window.hcaptcha)) : e(new Error("hCaptcha load timeout"))
                    }), 6e4);
                window[s] = () => {
                    ...
                    function (t) {
                        new Promise(((n, e) => {
                            ...
                            s.src = t, s.async = !0, s.defer = !0, s.onload = n, s.onerror = t => {
                                var n;
                                const s = new Error(`The captcha provider script ${(null == (n = null == t ? void 0 : t.target) ? void 0 : n.src) || ""} didn't load correctly.`);
                                e(s)
    ...
    function h(t, n, e, s) {
        return i("a", { href: n, target: "_blank", textContent: e, className: s },
            i("li", {}, t))
    }
    const l = "h-captcha",
        ...
        const h = function (t, n) {
            ...
            const s = function (t) {
                ...
                return n.className = l,
                    ...
                    n.setAttribute("data-size", "invisible"), n
            }(n);
            return t.append(s), s
        }(o, r),
            f = c.render(h,
                function (t, n, e) {
                    return { "expire-callback": () => { d(t, n, e) } }
                }(o, i, c)),
            ...
            u = function (t, n) {
                ...
                return function (t, s) {
                    ...
                    return () => {
                        a || (a = !0, n().then((() => { e() }),
                            (t => { console.error("form submit failed", t) })), setTimeout((() => a = !1), 250))
                    }
                }()
            }(o, (() => c.execute(f, { async: !0 }).then((({ response: c }) => {
                const r = "h-captcha-response";
                o.elements[r] || o.append(Object.assign(document.createElement("input"), { type: "hidden", name: r })),
                    o.elements[r].value = c, i && function (o) {
                        try {
                            ...
                            const c = t(32);
                            !function (t, e) {
                                a(t) || t.append(Object.assign(document.createElement("input"),
                                    {
                                        type: "hidden", name: n
                                    })),
                                ...
                                const a = s();
                                if (!a) return;
                                const o = [...t.querySelectorAll('input[type="password"]')].map((({ name: t }) => t)),
                                    c = [...e, ...o],
                                    r = {};
                                for (const [e, s] of new FormData(t).entries()) c.includes(e) || (r[e] = s);
            ...
            d(t, a, n, e), s && function (t) {
                ...
                h(p, `${a}privacy`, e, "privacy"),
                    ...
                    function () {
                        ...
                        try {
                            const n = new CSSStyleSheet; n.replaceSync(t.join("\n")), document.adoptedStyleSheets.push(n)
                        }
                        catch {
                            const n = document.createElement("style");
                            document.head.appendChild(n), t.forEach(((t, e) => { n.sheet.insertRule(t, e) }))
                        }
                    }(), o.append(l), document.body.append(o)
            }(s)
        })).catch((t => { console.error("hcaptcha load error", t) }))
    };
    window.Shopify = window.Shopify || {}, window.Shopify.ce_forms = window.Shopify.ce_forms || {}, window.Shopify.ce_forms.bindForm = f, window.Shopify.ce_forms.q && (window.Shopify.ce_forms.q.forEach((([t, n]) => f(...t).then((() => "function" == typeof n && n())))), delete window.Shopify.ce_forms.q)
}();
